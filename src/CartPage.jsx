...
const CartPage = () => {
  ...
  const handleCheckout = async () => {
    try {
      ...
      const options = {
        key: "rzp_test_GQ7OLJnSwBOil8", // Replace with your Razorpay Key ID
              ...
              <div key={item.product_id} className="cart-item">
                ...
                <div className="item-details">
                  ...
                  <div className="item-actions">
                    ...
                    <span className="price">Rs.{item.total_price}</span>
        ...
        <div className="checkout-section">
          ...
          <div className="checkout-summary">
            ...
            <div className="summary-row total">
              <span>Total</span>
              <span>Rs.{(parseFloat(subtotal) + parseFloat(shipping)).toFixed(2)}</span>
            </div>
